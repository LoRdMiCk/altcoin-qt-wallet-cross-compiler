...
echo "############ Compiling Barkeley DB 4.8 ############"
cd "$WORKDIR"
...
make -j8
make install
echo "############ Compiling Barkeley DB 4.8 Done ############"


echo "############ Compiling Mini UPNP ############"
cd "$WORKDIR"
...
echo "############ Compiling Mini UPNP Done ############"


echo "############ Compiling Alcoin QT Wallet ############"
...
echo "############ Compiling Alcoin QT Wallet Done ############"

echo "Our altcoin-qt.exe placed in $WORKDIR/$COIN_NAME/release"
